...
export class Performance extends Component {
	...
	PerformanceData = () => {
		const { goal, employeeAchievement,employeeSelfRating,thingsManagerShouldStart,thingsManagerShouldStop,thingsManagerShouldContinue,overallRating,   } = this.state;
		...
		getPerformance(userObj ? userObj.uniqueId : null).then(response => {
			if (response.data && response.data.error === 'false') {
				...
				data.Performanceapp && data.Performanceapp.map(value => {
					...
					// goal[value] = value;
					// employeeAchievement[value] = value;
					// employeeSelfRating[value] = value;
					// thingsManagerShouldStart [value] = value;
					// thingsManagerShouldStop[value] = value;
					// thingsManagerShouldContinue[value] = value;
					...
					// console.log(value);
					// console.log(value.thingsTheyShouldStart);
	...
	handleSubmit = () => {
			const { goal,user, employeeAchievement, thingsManagerShouldStart,
				thingsManagerShouldStop,
				thingsManagerShouldContinue,errors } = this.state;
			...
			let selfDevlopmentGoal = {thingsManagerShouldStart,
				thingsManagerShouldStop,
				thingsManagerShouldContinue,}
			
			let obj = 	{ kraSettings, selfDevlopmentGoal, userUniqueId, employeeAchievement,
				 errors }
