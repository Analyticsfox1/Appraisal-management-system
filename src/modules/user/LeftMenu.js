    ...
    return (
      <aside className="LeftMenu">
        ...
        <ul className="dash_ul">
          ...
          <li>
            <NavLink to="/probation-form" activeClassName="active">
              <i className="fas fa-hourglass-half"></i>
              <span>&nbsp;Probation Form</span>
            </NavLink>
          </li>
          <li>
            <NavLink to="/performance-appraisal" activeClassName="active">
              <i className="fas fa-briefcase"></i>
              <span>Performance Appraisal</span>
            </NavLink>
          </li>
          <li>
            <NavLink to="/monthly-meeting" activeClassName="active">
