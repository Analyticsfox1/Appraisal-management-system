				...
				<ul className="dash_ul">
					...
					<li className="has_drop"><NavLink><i className="fas fa-graduation-cap"></i><span>Appraisal</span></NavLink>
						<ul className="custom_drop">
							<li><NavLink to="/performance-appraisal" activeClassName="active"><i className="fas fa-theater-masks"></i><span>Performance</span></NavLink></li>
							<li><NavLink to="/monthly-appraisal" activeClassName="active">&nbsp;<i className="far fa-calendar-alt"></i><span>&nbsp;Monthly</span></NavLink></li>
						</ul>
					</li>
