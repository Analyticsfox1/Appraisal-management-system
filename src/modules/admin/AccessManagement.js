      ...
      this.setState(
        {
          ...
          role: response.data && response.data.data && response.data.data[0]
        },
  ...
  handleRole = role => {
    ...
    getAccessById(roleObj).then(response => {
      if (response.data && response.data.error === "false") {
        ...
        toast.success("Access is assigned to role", {
      ...
      if (response.data && response.data.error === "true") {
        ...
        toast.error("Access is not assigned to role", {
    ...
    this.setState({
      accessData: {
        ...
        [e.currentTarget.name]: {
          accessId: parseInt(e.currentTarget.value),
        ...
        Cell: ({ original }) => {
          return (
            <input
              ...
              checked={
                accessData &&
                accessData[original.pageId] &&
                accessData[original.pageId].accessId == "1"
              }
          ...
          return (
            <input
              ...
              checked={
                accessData &&
                accessData[original.pageId] &&
                accessData[original.pageId].accessId == "2"
              }
              onChange={e => this.onChanged(e, original)}
            />
          );
          ...
          return (
            <input
              ...
              checked={
                accessData &&
                accessData[original.pageId] &&
                accessData[original.pageId].accessId == "3"
              }
              onChange={e => this.onChanged(e, original)}
            />
          );
          ...
          <section className="container-fluid">
            ...
            <div className="row mt-4">
              ...
              <div className="d-flex col-md-8">
                <button onClick={this.handleSubmit} className="add-btn ml-auto">
                  {" "}
                  Add Access{" "}
                </button>
              </div>
