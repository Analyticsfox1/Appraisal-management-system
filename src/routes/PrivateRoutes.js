    ...
    return (
      <Router>
        <Switch>
          ...
          <PrivateRouteAdmin
            exact
            path="/member-assigned"
            component={MemberAssigned}
          />
          <PrivateRouteAdmin
            exact
            path="/member-not-assigned"
            component={MemberNotAssigned}
          />
          <PrivateRouteAdmin
            exact
            path="/new-register"
            component={NewRegistartion}
          />
          <PrivateRouteAdmin
            exact
          ...
          <PrivateRouteCEO
            exact
            path="/CEO-kra-management"
            component={CEOKraManagement}
          />
          <PrivateRouteCEO
            exact
            path="/CEO-team-management"
            component={CEOTeamManagement}
          />
          <PrivateRouteCEO
            exact
            path="/CEO-organizational-goal"
            component={CEOOrganizationGoal}
          />
          <PrivateRouteCEO
            exact
            path="/CEO-push-notification"
            component={CEOPushNotification}
          />
          {/* Manager Routes */}
          <PrivateRouteManager
            exact
          ...
          <PrivateRouteManager
            ...
            component={ManagerTeamManagement}
          />
          <PrivateRouteManager
            exact
            path="/manager-employee-probation-management"
            component={ManagerEmployeeProbation}
          />
          <PrivateRouteManager
            exact
            path="/manager-probation-form"
            component={ManagerProbationForm}
          />
          <PrivateRouteManager
            exact
