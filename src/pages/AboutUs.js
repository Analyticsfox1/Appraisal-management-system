			...
			<div className="about-page">
				...
				<section className="mb-5">
					<div className="container">
						...
						<h4 className="title-blue mt-5">Make your people feel valued</h4>
						<ul className="mt-3">
						...
						<h4 className="title-blue mt-5">Set new goals</h4>
						<ul className="mt-3">
						...
						<h4 className="title-blue mt-5">Resolve grievances</h4>
						<ul className="mt-3">
						...
						<h4 className="title-blue mt-5"> Refocusing your team</h4>
						<ul className="mt-3">
